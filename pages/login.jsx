/** ******************************
 * There should be a better way to handle the routing and 
 * components so that they do not have to be called in 
 * multiple times but I'm still trying to figure this out. 
 *  ***********************************/
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to the Destination Discovery! 
        </h1>
        <h2 className={styles.title3}>You will need to log in to start planning!</h2>
